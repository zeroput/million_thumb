...
import com.github.zeroput.million_thumb.model.enums.ThumbTypeEnum;
...
public class SyncThumb2DBJob {  
    ...
    public void syncThumb2DBByDate(String date) {  
        ...
        for (Object userIdBlogIdObj : allTempThumbMap.keySet()) {  
            ...
            if (thumbType == ThumbTypeEnum.ADD_ONE.getValue()) {
        ...
        if (!blogThumbCountMap.isEmpty()) {  
            blogMapper.batchUpdateBlogThumbCount(blogThumbCountMap);
        }  
        // 异步删除  
